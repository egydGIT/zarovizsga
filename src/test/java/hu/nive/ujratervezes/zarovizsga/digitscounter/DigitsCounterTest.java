...
class DigitsCounterTest {
    ...
    @Test                                                           // saját teszt, nem feladat
    void getCountOfDifferentCharacters() {
        DigitsCounter digitsCounter = new DigitsCounter();

        assertEquals(3, digitsCounter.getCountOfDifferentCharacters("abcabcabcabc"));
        assertEquals(3, digitsCounter.getCountOfDifferentCharacters("abc abc abc abc"));
    }
}